...
var shuffleSequence = seq("consent", "instructions", seq(startsWith("practice")),  sepWith("sep", seq(shuffle(randomize(startsWith("formal")), randomize(startsWith("informal"))), shuffle(randomize(startsWith("expert")), randomize(startsWith("non-expert"))))), "questionnaire");
