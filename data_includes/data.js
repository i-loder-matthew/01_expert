...
["partial-knowledge_31", "Question", { q: "Adele à son amie Marie, qui prends des bonnes notes dans le cours: \n Adele: Comme", as: ["Il y a quoi à reviser pour le prochain examen?", "Qu'est-ce qu'il y a à reviser pour le prochain examen?"] }],
["no-knowledge_32", "Question", { q: "Adele à son amie Marie, qui prends des bonnes notes dans le cours: \n Adele: Comme j'étais pas là au dernier cours, au fait", as: ["Il y a quoi à reviser pour le prochain examen?", "Qu'est-ce qu'il y a à reviser pour le prochain examen?"] }],
["partial-knowledge_33", "Question", { q: "Antoni à son ami Jean qui prend souvent le train:  \n …", as: ["Il s'arrete où le train de dix heures?", "Où il s'arrete le train de dix heures?"] }],
["no-knowledge_34", "Question", { q: "Antoni à son ami Jean qui prend souvent le train:  \n …", as: ["Il s'arrete où le train de dix heures?", "Où il s'arrete le train de dix heures?"] }],
["partial-knowledge_35", "Question", { q: "… \n …", as: ["Il coute combien, le plat du jour?", "Combien il coute, le plat du jour?"] }],
["no-knowledge_36", "Question", { q: "… \n …", as: ["Il coute combien, le plat du jour?", "Combien il coute, le plat du jour?"] }],
["formal_37", "Question", { q: "Un professeur du départment qui revient d’une conférence s’addressant a son collègue : \n Je ne sais pas si c'est étonnant, mais:", as: ["Il y avait pas d’etudiants de notre department à cette conference.", "Il n’y avait aucun etudiant de notre department à cette conference."] }],
["informal_38", "Question", { q: "Un étudiant s'adressant à un ami en revenant d'une conférence :  \n Je ne sais pas si c'est étonnant, mais:", as: ["Il y avait pas d’etudiants de notre department à cette conference.", "Il n’y avait aucun etudiant de notre department à cette conference."] }],
["formal_39", "Question", { q: "Le maire du village s'adressant a un employé :  \n Je l'ai visiter hier soir et:", as: ["Je n' ai pas vu de drapeaux sur la place.", "Je n'ai vu aucun drapeux sur la place."] }],
["informal_40", "Question", { q: "Un papa s'adressant à son enfant :  \n Je l'ai visiter hier soir et:", as: ["Je n' ai pas vu de drapeaux sur la place.", "Je n'ai vu aucun drapeux sur la place."] }],
["formal_41", "Question", { q: "Un professeur s'addressant a ses élèves : \n Je vous rappelle:", as: ["Vous n'avez aucun devoir à faire pendant les vacances.", "Vous n'avez pas de devoir à faire pendant les vacances."] }],
["informal_42", "Question", { q: "Un enfant s'adressant a sa mère : \n C'est vrai, maman!", as: ["Je n'ai aucun devoir à faire pendant les vacances.", "Je n'ai pas de devoir à faire pendant les vacances."] }],
